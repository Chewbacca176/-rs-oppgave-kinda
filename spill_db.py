...
bg = pygame.image.load("static/bilder/space3.jpeg")
screen = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption("You know when the")

heart_img = pygame.image.load("static/bilder/heart.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self,x,y):
        super().__init__()
        self.image = pygame.image.load("static/bilder/crab.png")
...
class Astroide(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.image = pygame.image.load("static/bilder/astroide.png")
...
class EkstraLiv(pygame.sprite.Sprite):
    def __init__(self,x,y):
        super().__init__()
        self.image = pygame.image.load("static/bilder/Health-potion.png")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN: 
                if bruker_navn2.collidepoint(mouse_pos):
                    ...
                    opprett_bruker(navn_tekst, etternavn_tekst, email_tekst, passord_tekst)
                    id = logg_inn(email_tekst, passord_tekst)
                    hent_poeng(id)
                    start_loop()
                else:
                    skrive_boks = 0
